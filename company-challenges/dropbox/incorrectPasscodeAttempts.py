""" incorrectPasscodeAttempts -- 5 min
...
in. However, the next 10 consecutive attempts are incorrect, so the device 
should be locked. Thus, the output should be true.
For
passcode = "1234" and
attempts = ["9999", "9999",
            "9999", "9999",
...
There are only 9 consecutive incorrect attempts, so there's no need to 
lock the device.
Input/Output
...
print(incorrectPasscodeAttempts(1111, ["1111", "4444",
            "9999", "3333",
            "8888", "2222",
            "7777", "0000",
            "6666", "7285",
